...
function NavBar() {
  ...
  const navItems = [
    ...
    {
      text: "DISCUSS",
      icon: <DiscussIcon fontSize="small" />,
      path: "/discuss",
    },
    {
      text: "ABOUT_US",
      icon: <AboutUsIcon fontSize="small" />,
      path: "/aboutUs",
    },
    { text: "CONTESTS", icon: <CodeIcon fontSize="small" />, path: "/contest" },
    {
      text: "PROFILE",
  ...
  const drawer = (
    ...
    >
      <Box
        sx={{ px: 2, display: "flex", alignItems: "center", gap: 1.5, mb: 3 }}
      >
        ...
        >
          CODECRAFT <span style={{ color: "#10b981" }}>OS</span>
        </Typography>
      </Box>
